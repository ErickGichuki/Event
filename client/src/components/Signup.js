...
function Signup() {
  ...
  return (
    <div>
      <div className=' flex flex-col bg-blue-100 full-screen items-center justify-center'>
      <h1 className='font-bold'>Welcome to our Management System</h1>
      </div>
      <div className='flex flex-col ml-2 items-center justify-center full-screen bg-blue-100'>
      <form className='bg-gray-300 shadow-md rounded-lg px-10 pt-8 pb-12 mb-4 w-full max-w-lg mt-4' onSubmit={formik.handleSubmit}>
